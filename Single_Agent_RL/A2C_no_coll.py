...
load_path = f"./saved_models/A2C/2022_0504_1123_24"
...
env = UnityEnvironment(file_name=env_name,
                        side_channels=[engine_configuration_channel], no_graphics=False, worker_id=2)
env.reset()
...
for step in range(run_step + test_step):
    ...
    next_state = term.obs[VECTOR_OBS]if done\
                    else dec.obs[VECTOR_OBS]
    score += reward[0]
